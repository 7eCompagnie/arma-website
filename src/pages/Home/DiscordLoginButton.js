        ...
        <Button
            ...
            onClick={() => {
                if (process.env.NODE_ENV === 'development')
                    ...
                    popupCenter("https://discord.com/api/oauth2/authorize?client_id=964847392543350835&redirect_uri=http%3A%2F%2Fs4.vxls.net%3A3000%2Fdashboard&response_type=code&scope=identify",
                        "Connexion à la 7ème Compagnie via Discord", 500, 700);
